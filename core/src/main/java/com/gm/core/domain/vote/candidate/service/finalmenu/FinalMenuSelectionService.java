package com.gm.core.domain.vote.candidate.service.finalmenu;
...
public class FinalMenuSelectionService {
    ...
    /** 잠긴 세션에서 한 후보를 확정하고 다음 단계로 전환한다. */
    ...
    /** 세션 행을 잠가 조회하고 요청 경로의 그룹과 일치하는지 확인한다. */
    ...
    /** 세션이 요청 경로의 그룹에 속하지 않으면 존재하지 않는 세션으로 처리한다. */
    ...
    /** 활성 방장만 최종 메뉴 결정 작업을 수행하도록 확인한다. */
